...
public class FavouriteCommand extends Command {
    ...
    public static final String MESSAGE_FAVOURITE_PERSON_SUCCESS = "Added Person: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_FAVOURITE_PERSON_SUCCESS, personToDelete));
    }
