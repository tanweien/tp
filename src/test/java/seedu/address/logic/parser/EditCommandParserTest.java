...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_FACULTY_AMY
                + VALID_ROLE_AMY + VALID_TELEGRAM_AMY + VALID_PHONE_AMY, Name.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + TELEGRAM_DESC_AMY
                + EMAIL_DESC_AMY + FACULTY_DESC_AMY + ROLE_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_AMY + TELEGRAM_DESC_AMY + EMAIL_DESC_AMY + FACULTY_DESC_AMY
                + ROLE_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_BOB + TELEGRAM_DESC_BOB
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                ...
                .withTelegram(VALID_TELEGRAM_BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
