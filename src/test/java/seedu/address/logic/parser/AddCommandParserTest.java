...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + ROLE_DESC_BOB + TELEGRAM_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + FACULTY_DESC_AMY
                + ROLE_DESC_AMY + TELEGRAM_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + FACULTY_DESC_BOB
                        + ROLE_DESC_BOB + TELEGRAM_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + FACULTY_DESC_BOB
                + VALID_ROLE_BOB + TELEGRAM_DESC_BOB, expectedMessage);

        // missing telegram prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + FACULTY_DESC_BOB
                        + VALID_TELEGRAM_BOB, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_FACULTY_BOB
                        + ROLE_DESC_BOB + VALID_TELEGRAM_BOB, expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + ROLE_DESC_BOB + TELEGRAM_DESC_BOB + TAG_DESC_HUSBAND
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_FACULTY_DESC + ROLE_DESC_BOB + TELEGRAM_DESC_BOB + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Faculty.MESSAGE_CONSTRAINTS);

        // invalid role
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + INVALID_ROLE_DESC + TELEGRAM_DESC_BOB + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Role.MESSAGE_CONSTRAINTS);

        // invalid TELEGRAM
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + ROLE_DESC_BOB + INVALID_TELEGRAM_DESC + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Telegram.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + ROLE_DESC_BOB + TELEGRAM_DESC_BOB + INVALID_TAG_DESC
                + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + FACULTY_DESC_BOB + ROLE_DESC_BOB
                + INVALID_TELEGRAM_DESC, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB
                        + EMAIL_DESC_BOB + FACULTY_DESC_BOB + ROLE_DESC_BOB + TELEGRAM_DESC_BOB
